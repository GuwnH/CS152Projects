...
#Routers for ball and triangle as key
...
#Routers for gourd as key
collision_router[ ('gourd', 'ball') ] = collision_ball_ball
collision_router[ ('gourd', 'triangle') ] = collision_ball_ball
collision_router[ ('gourd', 'block') ] = collision_ball_block

#Routers for arrow as key
collision_router[('arrow','block')] = collision_ball_block
collision_router[('arrow','triangle')] = collision_ball_ball
collision_router[ ('arrow', 'ball') ] = collision_ball_ball
